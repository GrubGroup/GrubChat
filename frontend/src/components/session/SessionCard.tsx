      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between md:gap-2">
        ...
        {complete && (
          <button
            ...
            className="flex h-9 w-full items-center justify-center gap-1.5 rounded-input bg-success px-3 text-caption font-medium text-on-success md:h-auto md:w-auto md:py-1.5"
          >

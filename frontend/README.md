...
/groups/:groupId/session/:sessionId        Your private AI agent chat
/groups/:groupId/session/:sessionId/done    Finished — waiting on the rest of the group
/groups/:groupId/session/:sessionId/picks   The group's top picks
...
To check: deploy, then hard-refresh a deep link such as `/groups/12/session/48`. It should load the
app, not a 404.
